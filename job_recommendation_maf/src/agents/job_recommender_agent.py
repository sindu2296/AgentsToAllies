...
def build_job_recommender_agent(chat_client: AzureOpenAIChatClient, name: str = "job_recommender_agent") -> ChatAgent:
    ...
    instructions = (
        ...
        "- Rank the jobs by relevance and fit, but ALWAYS recommend top 5 jobs "
        "- Return the top recommended jobs in a clear format for the summary agent "
        "- Include job title, company, location, and key details "
        ...
        "Always provide recommendations - your role is to help users find opportunities. "
