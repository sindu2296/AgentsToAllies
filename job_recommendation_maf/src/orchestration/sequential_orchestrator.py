...
async def run_job_recommendation_AI_workflow(chat_client: AzureOpenAIChatClient, user_profile: str) -> str:
    ...
    if all_messages:
        return _format_staged_results(all_messages, user_profile)
    else:
        return "No results generated by the workflow."


def _format_staged_results(all_messages, user_profile):
    ...
    _log_detailed_stages(job_extraction, job_analysis, job_summary, user_profile)
